...
/**
 * @Description ApiMemberPayRuleControllerTest 单元测试类
 * @Author zhaokw
 * @Date 10:05 2020\8\23 0023
 **/
@RunWith(SpringRunner.class)
@SpringBootTest
public class ApiMemberPayRuleControllerTest {
    ...
    public void getMemberPayRule() throws Exception {
        ...
        MvcResult result = mockMvc.perform(get("/api/getMemberPayRule"))
    ...
    public void memberPay() throws Exception {
        ...
        String obj = JSONObject.toJSONString(memberPayDto);
        MvcResult result = mockMvc.perform(post("/api/memberPay").content(obj))
