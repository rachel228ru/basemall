<template>
<uni-shadow-root class="vant-weapp-picker-toolbar"><view v-if="showToolbar" class="van-picker__toolbar toolbar-class">
...
global['__wxRoute'] = 'vant-weapp/picker/toolbar'

Component({})

export default global['__wxComponents']['vant-weapp/picker/toolbar']
</script>
